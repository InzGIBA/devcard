<script lang="ts">
	...
	import { validateGitHubUsername } from '$entities/portfolio/model/types';
...
<section
	class="relative z-10 flex flex-col items-center justify-center px-6 pt-16 pb-20 text-center md:pt-40 md:pb-32"
>
